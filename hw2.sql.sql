...
CREATE TABLE Borders (countryName VARCHAR(20),
		      borderCountry VARCHAR(20));
...
SELECT * FROM Borders WHERE countryName = 'Germany' or borderCountry = 'Germany';

SELECT * FROM Countries WHERE population > 35000000;

SELECT * FROM Borders AND FROM Countries WHERE (population > 35000000 AND LIKE '%Germany%');
